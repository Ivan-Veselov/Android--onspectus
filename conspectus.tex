...
\newcommand{\Section}[1]{
  ...
  \begin{center}
    {\Large \bf Пункт \NO{\arabic{section}}} \\ 
    \vspace{\sectionvskip}
    {\Large \bf #1} \\
  \end{center}
  ...
  % Заголовок страницы
  \lhead{Конспект семинара по Android, User Interface}
  \chead{}
  \rhead{\SectionName}
  \renewcommand{\headrulewidth}{0.4pt}

  \lfoot{Пункт \NO{\arabic{section}}}
  \cfoot{\thepage\t{/}\pageref*{LastPage}}
  \rfoot{Авторы конспекта: Белова Татьяна,\\Веселов Иван,\\Винниченко Максим}
...
\input 01-views/views.tex
\input 02-layouts/layouts.tex
\input 03-input-controls/input-controls.tex

\input 04-logs/logs.tex
\input 05-toasts/toasts.tex

\input 06-context-menus/context-menus.tex
\input 07-list-views/list-views.tex
